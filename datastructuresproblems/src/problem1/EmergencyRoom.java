...
public class EmergencyRoom {
            ...
            if (color.equals("red")) {
                ...
                while (!queue.isEmpty()) {
                    ...
                    if ((color.equals("blue") && currentPatient.color.equals("red"))
                        ...
                        // For blue patients, insert before red patients
                        // For green patients, insert before red and after blue patients
                ...
                // Restore the queue with the new order
    ...
    public static void sortQueue(Deque<Patient> queue) {
        ...
        Comparator<Patient> patientComparator = Comparator.comparing((Patient p) -> p.color.equals("red") ? 0 : (p.color.equals("blue") ? 1 : 2)).thenComparing(p -> p.name);
